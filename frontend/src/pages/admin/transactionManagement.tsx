...
//               <img src={`${server}/${i.photo}`} alt={i.name} className="w-20 h-20 object-cover rounded-md mr-6" />
//               <div>
//                 <h3 className="text-lg font-semibold">{i.name}</h3>
//                 <span className="text-gray-600">${i.price} X {i.quantity}={i.price * i.quantity}</span>
...
//           </p>
//           <p>
//             <span className="font-semibold">Address:</span>{`${address}, ${city}, ${status}, ${country},${pinCode}`}
//           </p>
